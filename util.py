...
def prepare_data(data_path):
    input_characters, target_characters, _, _ = extract_chars(data_path)
    encoder_input_data, decoder_input_data, decoder_target_data, input_token_index, target_token_index, _, _, _, _, _, _ = encode_chars(
        input_characters, target_characters, _, _
    )
    return encoder_input_data, decoder_input_data, decoder_target_data, input_token_index, target_token_index, _, _, _, _, _, _


def extract_chars(data_path, exchange_language=False):
    input_texts = []
    target_texts = []
...
def encode_chars(input_characters, target_characters, input_texts, target_texts):
...
def create_translation_model(num_encoder_tokens, num_decoder_tokens):
...
def train_seq2seq(model, encoder_input_data, decoder_input_data, decoder_target_data):
    LOG_PATH = "/output/log"
...
def generate_inference_model(encoder_inputs, encoder_states, input_token_index, target_token_index, decoder_lstm, decoder_inputs, decoder_dense):
...
def encode_sentence_to_predict(sentence, input_token_index, max_encoder_seq_length, num_encoder_tokens):
...
def save_char2encoding(filename, input_token_index, max_encoder_seq_length, num_encoder_tokens, reverse_target_char_index, num_decoder_tokens, target_token_index):
...
def get_char2encoding(filename):
